 ...
 */
 Router::connect('/template/{:args}', 'Template::template');
 Router::connect('/render/{:action}/{:args}', 'Render::view');
 Router::connect('/templates', 'Templates::templates');
 Router::connect('/', 'Home::view');
 Router::connect('/{:args}', 'Home::view');
 Router::connect('/{:action}', array('Home::home', 'args' => array('home')));
