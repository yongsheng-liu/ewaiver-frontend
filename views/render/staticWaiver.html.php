...
<div name="myForm" novalidate class="template">
    ...
    <?php if ($clientIP && $userId != 18939):?>
        <div class="signedDate" style="color: grey;">IP Address: <?=$clientIP?></div>
    <?php endif;?>
    ...
    <div class="headerInfo" style="overflow: hidden;">
        ...
        <?php if (array_key_exists('logoImage', $Header) && strlen($logoImage) > 0):?>
            <img style="<?=$headerStyle['logoStyle']?>" src="<?=$logoImage?>"/>
        <?php endif;?>
        <p class="headerInfo" style="<?=$headerStyle['headerStyle']?>.'overflow:hidden;'">
        ...
        <?php foreach ($Additionals as $t): ?>
                        ...
                        <div class="form-group">
                            <p>
                                ...
                                <?php elseif  ($t['type'] == 'video'):?>
                                    <img class="videoImg" src="<?=$videoImage?>"/>
                                <?php endif;?>
                            </p>
                        </div>
                    </div>
            ...
            <?php elseif ($t['type'] == 'multiple'): ?>
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class = "additional" >
                        <div class="form-group">
                            <span><strong><?=$t['text']?></strong></span><br/>
            ...
            <?php elseif($t['type'] == 'takePic' && $t['value']): ?>
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        ...
                        <div><img class="tp-initial" src="<?=$t['value']?>"></div>
                    </div>
                <?php endif;?>
            ...
            <?php elseif($t['type'] == 'image' && $t['value']): ?>
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        <div><img style="max-width:100%;" src="<?=$t['value']?>"></div>
                    </div>
                <?php endif;?>
            ...
            <?php elseif($t['type'] == 'date' || $t['type'] == 'dob'): ?>
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        ...
                        <div>
                            <?= $this->WaiverHelper->getDateValue($t)?>
                        </div>
                    </div>
                <?php endif;?>
                ...
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        <span>
                            ...
                            <strong style="margin-left: 10px;"><?=$t['text']?>
                                <span>
                                <?php if ($t['optional'] == false): ?>
                                    (Required)
                                <?php endif;?>
                ...
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        ...
                        <?php elseif (array_key_exists('dataUrl', $t) && array_key_exists('dataUrl', $t['dataUrl'])):?>
                            <div class="initialPad-outPointer"><img class="tp-initial" src="<?=$t['dataUrl']['dataUrl']?>"></div>
                        <?php endif;?>
                        <span class="initialPad-label"><?=$t['text']?></span>
                    </div>
                <?php endif;?>
                    ...
                    <div class="form-group">
                        ...
                        <span><strong><?=$t['text']?>
                            ...
                            <?php if (!$t["dataUrl"]):?>
                                <div><img src=""/></div>
                            <?php elseif (array_key_exists('dataUrl', $t) && array_key_exists('dataUrl', $t['dataUrl'])):?>
                                <div><img src="<?=$t['dataUrl']['dataUrl']?>"/></div>
                            <?php endif;?>
                        </div>
                    </div>
                <?php endif;?>
            ...
            <?php elseif($t['type'] == 'stripe'): ?>
                <?php if (!($t['minorsOnly'] && !$waiver['showMinorTemplate'] && $Settings['minor']['enable'] == 'true')):?>
                    <div class="form-group">
                        <span><strong style="display:block;"><?=$t['text']?>
                                <span>
                                <?php if ($t['optional'] == false): ?>
                                    (Required)
                                <?php endif;?>
                            ...
                            <?php if($t['paid']):?>
                                <div><span>Paid $<?=$t['paidValue']?></span></div>
                            <?php endif;?>
                            <?php if(!$t['paid']):?>
            ...
            <?php elseif ($t['type'] == 'multiple'): ?>
                <div class="form-group">
                    ...
                    <div>
                        <?php if($t['dropDownStyle']): ?>
                            <?php if($t['dropDownStyleValue'] && $t['dropDownStyleValue'] != $t['othersText'] && $t['dropDownStyleValue'] != 'dropDownStyleValueOthers'): ?>
                                <span><?=$t['dropDownStyleValue']?></span>
                            <?php endif;?>

                            <?php if($t['dropDownStyleValue'] == $t['othersText'] || $t['dropDownStyleValue'] == 'dropDownStyleValueOthers'): ?>
                                <div><span><?=$t['othersValue'] ?></span></div>
                            <?php endif;?>
                        <?php endif;?>
                        <?php if(!$t['dropDownStyle']): ?>
    ...
    <div class="lastSections">
        <div class="signatureContent">
            <strong>
                <?=$LastSections['signatureContent']?>
            </strong>
        </div>
        <div class="signatureContentText"><?=$LastSections['signatureContent']?></div>

        <div class="signatures">
            <?php  foreach ($LastSections['signatures'] as $t): ?>
                <?php if($t['type'] == 'shortAns'): ?>
                <div class="form-group">
                    <span><strong><?=$t['signatureText']?>
                            <span>
                            <?php if ($t['optional'] == false): ?>
                                (Required)
                            <?php endif;?>
        ...
        <div class="notes">
            ...
            <?php  foreach ($notes as $n): ?>
                ...
                <?php  foreach ($n['notesSignatures'] as $s): ?>
                    <div><img src="<?=$s['value']['dataUrl']?>"/></div>
                <?php endforeach;?>
            <?php endforeach;?>
            <hr/>
        </div>
