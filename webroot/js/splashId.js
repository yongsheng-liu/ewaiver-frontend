...
(function () {
  splashId = document.getElementById("splashId").getAttribute("data-value");

  var text = document.getElementById("splashId").getAttribute("data-text"); 
  if (text.length > 0){
    dataText = text;
  }

  var position = document.getElementById("splashId").getAttribute("data-position");
  if (position && position == 'left') {
    dataPosition = 'left: 30px;';
  }

  var backgroundColor = document.getElementById("splashId").getAttribute("data-backgroundColor");
  if (backgroundColor) {
    dataBackgroundColor = backgroundColor;
  }

  var fontColor = document.getElementById("splashId").getAttribute("data-fontColor");
  if (fontColor) {
...
var cssSrting = '<style type="text/css">'
              ...
              +'#waiverElectronic_link {'
                ...
                +'border-top-right-radius: 4px !important;font-family: "Verdana" !important;line-height:20px;'
              ...
              +'}'
        +'</style>'
var toHtml = '<div id="waiverElectronic_floater">'
            ...
            +'<div id="waiverElectronic_iframe_div">'
                +'<iframe id="waiverElectronic_iframe" onload="loadSplash()" src="https://www.waiverelectronic.com/render/splash/'+splashId+'" frameborder=0 ></iframe>'
            +'</div>'
        +'</div>'

var splashContainer = document.getElementById("splashId");
var splashContent = document.createElement("div");
splashContent.innerHTML = cssSrting + toHtml;
