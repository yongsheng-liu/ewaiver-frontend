...
<div class="peptide-resources-content">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#handling"  role="tab" data-toggle="tab">Peptide Handling</a></li>
        <li role="presentation"><a href="#modifications"  role="tab" data-toggle="tab">Peptide Modifications</a></li>
        <li role="presentation"><a href="#acids"  role="tab" data-toggle="tab">Amino Acids</a></li>
        <li role="presentation"><a href="#antigen"  role="tab" data-toggle="tab">Peptide Antigen Design</a></li>
        <li role="presentation"><a href="#properties" role="tab" data-toggle="tab">Fluorophore Properties</a></li>
    </ul>
...
<script>
	...
	// 	var prId = e.relatedTarget.hash;
    //     console.log(prId)
    //     console.log(id)
    //     $(prId).addClass('out');
    //     //$(prId).removeClass('in');
    //     // setTimeout(() => {
    //     //     $(prId).removeClass('active');
    //     //     $(id).addClass('active');
    //     //     $(id).addClass('in');
    //     //     $(prId).removeClass('out');
    //     // }, 500);
	// });
